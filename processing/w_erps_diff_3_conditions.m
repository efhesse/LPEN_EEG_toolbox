function [ EEG, data ] = w_erps_diff_3_conditions( condition_1, condition_2, condition_3, roi_struct_filename, roi_struct_name, files_prefix, tlimits, cycles, frequency_range, alpha, fdr_correct, weighted_significance, surroundings_weight, scale, basenorm, tlimits_for_baseline, erps_max, mark_times, path_to_save, EEG, data )
