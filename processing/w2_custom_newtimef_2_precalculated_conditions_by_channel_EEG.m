function data = w2_custom_newtimef_2_precalculated_conditions_by_channel_EEG(path_to_files,condition1_data,condition2_data,path_to_save,data)
...
cond1_file_name = fullfile(path_to_files,condition1_data);
assert(exist(cond1_file_name, 'file') == 2,['File not found! condition1_data: ' cond1_file_name '.']);

cond2_file_name = fullfile(path_to_files,condition2_data);
