function [P,R,mbase,timesout,freqs,Pboot,Rboot,alltfX,g] = newtimef_2_conditions( data, frames, tlimits, Fs, varwin, varargin);
...
if iscell(data)
    ...
    if ~isempty(g.timeStretchMarks)
        [P1,R1,mbase1,timesout,freqs,Pboot1,Rboot1,alltfX1] = ...
            m_newtimef( data{1}, frames, tlimits, Fs, g.cycles, 'plotitc', 'off', ...
    ...
    [P2,R2,mbase2,timesout,freqs,Pboot2,Rboot2,alltfX2] = ...
        m_newtimef( data{2}, frames, tlimits, Fs, g.cycles, 'plotitc', 'off', ...
        'plotersp', 'off', vararginori{:}, 'lowmem', 'off', ...
